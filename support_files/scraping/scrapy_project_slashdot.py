...
class ScrapyProjectSlashdot:
    ...
    @snoop
    def spider(self):
        """Creation of file that defines spider behaviour."""
    ...
    def parse(self, response):
        srch_titles = response.xpath('//span[@class="story-title"]/a/text()').getall()
        srch_links = response.xpath('//*/a[@href]').getall()
        srch_content = response.xpath('//i/text()').getall(()
