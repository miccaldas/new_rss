...
class SPIDER_1947(scrapy.Spider):
    name = 'spider_1947'

    start_urls = ["https://www.eurogamer.net/articles/2022-02-03-star-citizen-slimming-down-roadmap-to-stop-having-to-update-roadmap"]
