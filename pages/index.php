<!DOCTYPE html>
                                <html lang="en">
                                <head><br><title>HP</title><br><meta name="viewport" content="width=device-width, initial-scale=1.0">
  ...
  <link rel="stylesheet" type="text/css" href="http://localhost/new_rss/css/index.css" media="screen">
  <link rel="stylesheet" type="text/css" href="http://localhost/new_rss/css/tachyons.css" media="screen">
  <style>
    p {
        margin-bottom: -1em;
  }
