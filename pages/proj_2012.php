<!DOCTYPE html>
                                <html lang="en">
                                <head><br><title>On this day, the 3rd of February 1830. The London Protocol establishes the full independence and sovereignty of Greece from the Ottoman Empire as the final result of the Greek War of Independence.</title><br><meta name="viewport" content="width=device-width, initial-scale=1.0">
  ...
  <div id="page_container" class="relative min-h-100 overflow-hidden db">
    <div id="content_wrap" class="pb3">
      ...
      <div id="flex-container" class="flex mt=2 mb=2">
        ...
        <div id="col2" class="flex-row items-center self-center justify-center content-center w-80 order-1 mb4"><br><h1>On this day, the 3rd of February 1830. The London Protocol establishes the full independence and sovereignty of Greece from the Ottoman Empire as the final result of the Greek War of Independence.</h1><br><?php require '/usr/share/nginx/html/new_rss/support_files/scraping/entries/proj_2012/content.php'; ?><br><a href='https://www.reddit.com/r/europe/comments/sjck4o/on_this_day_the_3rd_of_february_1830_the_london/'>LINK</a> </div>
