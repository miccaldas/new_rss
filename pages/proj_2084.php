<!DOCTYPE html>
                                <html lang="en">
                                <head><br><title>Demystifying the profraw format</title><br><meta name="viewport" content="width=device-width, initial-scale=1.0">
  ...
  <div id="page_container" class="relative min-h-100 overflow-hidden db">
    <div id="content_wrap" class="pb3">
      ...
      <div id="flex-container" class="flex mt=2 mb=2">
        ...
        <div id="col2" class="flex-row items-center self-center justify-center content-center w-80 order-1 mb4"><br><h1>Demystifying the profraw format</h1><br><?php require '/usr/share/nginx/html/new_rss/support_files/scraping/entries/proj_2084/content.php'; ?><br><a href='https://leodido.dev/demystifying-profraw/'>LINK</a> </div>
