<!DOCTYPE html>
                                <html lang="en">
                                <head><br><title>Looking Back, Leaping Forward: A look back at the first year for AlmaLinux and what the future holds</title><br><meta name="viewport" content="width=device-width, initial-scale=1.0">
  ...
  <div id="page_container" class="relative min-h-100 overflow-hidden db">
    <div id="content_wrap" class="pb3">
      ...
      <div id="flex-container" class="flex mt=2 mb=2">
        ...
        <div id="col2" class="flex-row items-center self-center justify-center content-center w-80 order-1 mb4"><br><h1>Looking Back, Leaping Forward: A look back at the first year for AlmaLinux and what the future holds</h1><br><?php require '/usr/share/nginx/html/new_rss/support_files/scraping/entries/proj_1997/content.php'; ?><br><a href='https://www.reddit.com/r/linux/comments/sj9b11/looking_back_leaping_forward_a_look_back_at_the/'>LINK</a> </div>
