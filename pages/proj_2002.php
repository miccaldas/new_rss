<!DOCTYPE html>
                                <html lang="en">
                                <head><br><title>Restoring from backup: deja dup and timeshift</title><br><meta name="viewport" content="width=device-width, initial-scale=1.0">
  ...
  <div id="page_container" class="relative min-h-100 overflow-hidden db">
    <div id="content_wrap" class="pb3">
      ...
      <div id="flex-container" class="flex mt=2 mb=2">
        ...
        <div id="col2" class="flex-row items-center self-center justify-center content-center w-80 order-1 mb4"><br><h1>Restoring from backup: deja dup and timeshift</h1><br><?php require '/usr/share/nginx/html/new_rss/support_files/scraping/entries/proj_2002/content.php'; ?><br><a href='https://www.reddit.com/r/linux/comments/sivonr/restoring_from_backup_deja_dup_and_timeshift/'>LINK</a> </div>
