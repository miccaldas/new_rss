<!DOCTYPE html>
                                <html lang="en">
                                <head><br><title>GDPR enforcer rules that IAB Europe's consent popups are unlawful</title><br><meta name="viewport" content="width=device-width, initial-scale=1.0">
  ...
  <div id="page_container" class="relative min-h-100 overflow-hidden db">
    <div id="content_wrap" class="pb3">
      ...
      <div id="flex-container" class="flex mt=2 mb=2">
        ...
        <div id="col2" class="flex-row items-center self-center justify-center content-center w-80 order-1 mb4"><br><h1>GDPR enforcer rules that IAB Europe's consent popups are unlawful</h1><br><?php require '/usr/share/nginx/html/new_rss/support_files/scraping/entries/proj_2068/content.php'; ?><br><a href='https://www.iccl.ie/news/gdpr-enforcer-rules-that-iab-europes-consent-popups-are-unlawful/'>LINK</a> </div>
