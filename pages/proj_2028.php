<!DOCTYPE html>
                                <html lang="en">
                                <head><br><title>Nello & Patrasche from the novel "A Dog of Flanders". This sculpture is part of the pavement. Antwerpen</title><br><meta name="viewport" content="width=device-width, initial-scale=1.0">
  ...
  <div id="page_container" class="relative min-h-100 overflow-hidden db">
    <div id="content_wrap" class="pb3">
      ...
      <div id="flex-container" class="flex mt=2 mb=2">
        ...
        <div id="col2" class="flex-row items-center self-center justify-center content-center w-80 order-1 mb4"><br><h1>Nello & Patrasche from the novel "A Dog of Flanders". This sculpture is part of the pavement. Antwerpen</h1><br><?php require '/usr/share/nginx/html/new_rss/support_files/scraping/entries/proj_2028/content.php'; ?><br><a href='https://www.reddit.com/r/europe/comments/sirq3x/nello_patrasche_from_the_novel_a_dog_of_flanders/'>LINK</a> </div>
