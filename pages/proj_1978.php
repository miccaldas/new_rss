<!DOCTYPE html>
                                <html lang="en">
                                <head><br><title>When we do `code .` to open vscode, the terminal opens it and again is ready to take commands BUT when we do `idea64.exe .`, terminal opens intellij but the terminal continually stays on that idea64.exe command.</title><br><meta name="viewport" content="width=device-width, initial-scale=1.0">
  ...
  <div id="page_container" class="relative min-h-100 overflow-hidden db">
    <div id="content_wrap" class="pb3">
      ...
      <div id="flex-container" class="flex mt=2 mb=2">
        ...
        <div id="col2" class="flex-row items-center self-center justify-center content-center w-80 order-1 mb4"><br><h1>When we do `code .` to open vscode, the terminal opens it and again is ready to take commands BUT when we do `idea64.exe .`, terminal opens intellij but the terminal continually stays on that idea64.exe command.</h1><br><?php require '/usr/share/nginx/html/new_rss/support_files/scraping/entries/proj_1978/content.php'; ?><br><a href='https://www.reddit.com/r/commandline/comments/shttaz/when_we_do_code_to_open_vscode_the_terminal_opens/'>LINK</a> </div>
