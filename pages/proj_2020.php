<!DOCTYPE html>
                                <html lang="en">
                                <head><br><title>On 3 February 1966, humankind achieved its first soft landing on the Moon - the achievement belongs to the Soviet space probe Luna 9</title><br><meta name="viewport" content="width=device-width, initial-scale=1.0">
  ...
  <div id="page_container" class="relative min-h-100 overflow-hidden db">
    <div id="content_wrap" class="pb3">
      ...
      <div id="flex-container" class="flex mt=2 mb=2">
        ...
        <div id="col2" class="flex-row items-center self-center justify-center content-center w-80 order-1 mb4"><br><h1>On 3 February 1966, humankind achieved its first soft landing on the Moon - the achievement belongs to the Soviet space probe Luna 9</h1><br><?php require '/usr/share/nginx/html/new_rss/support_files/scraping/entries/proj_2020/content.php'; ?><br><a href='https://www.reddit.com/r/europe/comments/sjewpw/on_3_february_1966_humankind_achieved_its_first/'>LINK</a> </div>
