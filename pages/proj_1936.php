<!DOCTYPE html>
                                <html lang="en">
                                <head><br><title>Ask HN: General Mood of the Community</title><br><meta name="viewport" content="width=device-width, initial-scale=1.0">
  ...
  <div id="page_container" class="relative min-h-100 overflow-hidden db">
    <div id="content_wrap" class="pb3">
      ...
      <div id="flex-container" class="flex mt=2 mb=2">
        ...
        <div id="col2" class="flex-row items-center self-center justify-center content-center w-80 order-1 mb4"><br><h1>Ask HN: General Mood of the Community</h1><br><?php require '/usr/share/nginx/html/new_rss/support_files/scraping/entries/proj_1936/content.php'; ?><br><a href='https://news.ycombinator.com/item?id=30193946'>LINK</a> </div>
