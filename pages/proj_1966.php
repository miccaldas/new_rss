<!DOCTYPE html>
                                <html lang="en">
                                <head><br><title>I'm working on a commandline app that plays videos, any feedback is welcome</title><br><meta name="viewport" content="width=device-width, initial-scale=1.0">
  ...
  <div id="page_container" class="relative min-h-100 overflow-hidden db">
    <div id="content_wrap" class="pb3">
      ...
      <div id="flex-container" class="flex mt=2 mb=2">
        ...
        <div id="col2" class="flex-row items-center self-center justify-center content-center w-80 order-1 mb4"><br><h1>I'm working on a commandline app that plays videos, any feedback is welcome</h1><br><?php require '/usr/share/nginx/html/new_rss/support_files/scraping/entries/proj_1966/content.php'; ?><br><a href='https://www.reddit.com/r/commandline/comments/shz62v/im_working_on_a_commandline_app_that_plays_videos/'>LINK</a> </div>
