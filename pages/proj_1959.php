<!DOCTYPE html>
                                <html lang="en">
                                <head><br><title>I wanted to learn some assembly, so I made this terminal-based snake game for Linux x86_64</title><br><meta name="viewport" content="width=device-width, initial-scale=1.0">
  ...
  <div id="page_container" class="relative min-h-100 overflow-hidden db">
    <div id="content_wrap" class="pb3">
      ...
      <div id="flex-container" class="flex mt=2 mb=2">
        ...
        <div id="col2" class="flex-row items-center self-center justify-center content-center w-80 order-1 mb4"><br><h1>I wanted to learn some assembly, so I made this terminal-based snake game for Linux x86_64</h1><br><?php require '/usr/share/nginx/html/new_rss/support_files/scraping/entries/proj_1959/content.php'; ?><br><a href='https://www.reddit.com/r/commandline/comments/sixafz/i_wanted_to_learn_some_assembly_so_i_made_this/'>LINK</a> </div>
