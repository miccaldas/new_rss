<!DOCTYPE html>
                                <html lang="en">
                                <head><br><title>Why Flatpak is bad (and how to fix it)</title><br><meta name="viewport" content="width=device-width, initial-scale=1.0">
  ...
  <div id="page_container" class="relative min-h-100 overflow-hidden db">
    <div id="content_wrap" class="pb3">
      ...
      <div id="flex-container" class="flex mt=2 mb=2">
        ...
        <div id="col2" class="flex-row items-center self-center justify-center content-center w-80 order-1 mb4"><br><h1>Why Flatpak is bad (and how to fix it)</h1><br><?php require '/usr/share/nginx/html/new_rss/support_files/scraping/entries/proj_2005/content.php'; ?><br><a href='https://www.reddit.com/r/linux/comments/sjgn1g/why_flatpak_is_bad_and_how_to_fix_it/'>LINK</a> </div>
