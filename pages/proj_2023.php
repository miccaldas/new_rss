<!DOCTYPE html>
                                <html lang="en">
                                <head><br><title>You guys think 6 euros is much for 1 kg of cucumber? Here is 40 euros for 500 g of strawberries at a normal not luxurious supermarket in Hungary</title><br><meta name="viewport" content="width=device-width, initial-scale=1.0">
  ...
  <div id="page_container" class="relative min-h-100 overflow-hidden db">
    <div id="content_wrap" class="pb3">
      ...
      <div id="flex-container" class="flex mt=2 mb=2">
        ...
        <div id="col2" class="flex-row items-center self-center justify-center content-center w-80 order-1 mb4"><br><h1>You guys think 6 euros is much for 1 kg of cucumber? Here is 40 euros for 500 g of strawberries at a normal not luxurious supermarket in Hungary</h1><br><?php require '/usr/share/nginx/html/new_rss/support_files/scraping/entries/proj_2023/content.php'; ?><br><a href='https://www.reddit.com/r/europe/comments/sjnay9/you_guys_think_6_euros_is_much_for_1_kg_of/'>LINK</a> </div>
