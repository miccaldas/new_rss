<!DOCTYPE html>
                                <html lang="en">
                                <head><br><title>Command Line for the 21st Century: The Low Hanging Fruit</title><br><meta name="viewport" content="width=device-width, initial-scale=1.0">
  ...
  <div id="page_container" class="relative min-h-100 overflow-hidden db">
    <div id="content_wrap" class="pb3">
      ...
      <div id="flex-container" class="flex mt=2 mb=2">
        ...
        <div id="col2" class="flex-row items-center self-center justify-center content-center w-80 order-1 mb4"><br><h1>Command Line for the 21st Century: The Low Hanging Fruit</h1><br><?php require '/usr/share/nginx/html/new_rss/support_files/scraping/entries/proj_1970/content.php'; ?><br><a href='https://www.reddit.com/r/commandline/comments/si5ok6/command_line_for_the_21st_century_the_low_hanging/'>LINK</a> </div>
