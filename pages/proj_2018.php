<!DOCTYPE html>
                                <html lang="en">
                                <head><br><title>In the Byzantine times, monks had the inspiration to construct monasteries on top of these rocks so that they would be closer to god. The foundation of Meteora monasteries began around the 11th century. Today these monastaries are still in good shape and maintained by it's citizens monks.</title><br><meta name="viewport" content="width=device-width, initial-scale=1.0">
  ...
  <div id="page_container" class="relative min-h-100 overflow-hidden db">
    <div id="content_wrap" class="pb3">
      ...
      <div id="flex-container" class="flex mt=2 mb=2">
        ...
        <div id="col2" class="flex-row items-center self-center justify-center content-center w-80 order-1 mb4"><br><h1>In the Byzantine times, monks had the inspiration to construct monasteries on top of these rocks so that they would be closer to god. The foundation of Meteora monasteries began around the 11th century. Today these monastaries are still in good shape and maintained by it's citizens monks.</h1><br><?php require '/usr/share/nginx/html/new_rss/support_files/scraping/entries/proj_2018/content.php'; ?><br><a href='https://www.reddit.com/r/europe/comments/sjd2uu/in_the_byzantine_times_monks_had_the_inspiration/'>LINK</a> </div>
